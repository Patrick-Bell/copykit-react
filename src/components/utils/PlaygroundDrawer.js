...
const PlaygroundDrawer = ({ isDrawerOpen, toggleDrawer, buttonColor, setButtonColor, buttonBackground, setButtonBackground, buttonText, setButtonText, buttonVariant, setButtonVariant, duration, setDuration, showSnackbar, setShowSnackbar, showTooltip, setShowTooltip}) => {
